...
function sv_rewind(slot:integer; t:integer ):integer; stdcall; external LIBNAME;
function sv_volume( slot:integer; vol:integer ):integer; stdcall; external LIBNAME;
function sv_send_event(slot:integer; channel_num, note, vel, module, ctl, ctl_val :integer):integer; stdcall; external LIBNAME;
...
type
  ...
  tsv_send_event = function (slot:integer; channel_num, note, vel, module, ctl, ctl_val :integer):integer; stdcall ;
